...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        try:
            ...
            try:
                return importlib.import_module('static._snowboydetect')
            except:
                print("没有在static目录找到_snowboydetect.so文件")
                sys.exit()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('static._snowboydetect', [dirname(__file__)])
        except ImportError:
            import _snowboydetect
            return _snowboydetect
        if fp is not None:
            try:
                _mod = imp.load_module('static._snowboydetect', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _snowboydetect = swig_import_helper()
